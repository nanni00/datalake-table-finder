...
class MATETableExtraction:
    ...
    dataset_name : str
        Name of the query dataset. Used in case the user want to
        save posting lists on cached files.
    ...
    def hash_row_vals(self, hash_function: Any, row: Any, hash_size: int) -> None:
        ...
        for q in self.query_columns:
            ...
            hresult = hresult | hash_function(row[q], hash_size)
        return hresult
    ...
    def run_system_multi_sci(self, run_ics: bool = False, active_pruning: bool = True):
        ...
        info_to_store = f'fetching_time_1 = {fetching_time_1}, fetching_time_2 = {fetching_time_2}, evaluation_time = {evaluation_time}, joinability_average = {joinability_average} , '
        # lg = logger(self.dataset_name)
        # lg.log(self.log_file_name, info_to_store, 'Dataset: {}'.format(self.dataset_name), self.log_file_name)
        print(self.log_file_name, info_to_store, f'Dataset: {self.dataset_name}', self.log_file_name)
