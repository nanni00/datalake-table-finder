    ...
    match dlh.datalake_location:
        ...
        case _:
                ...
                init_rdd = (
                    ...
                    .map(lambda tabid_tabf: (tabid_tabf[0], pl.read_csv(f'{dlh.datalake_location}/tables/{tabid_tabf[1]}.csv', infer_schema_length=0, has_header=True, encoding='latin1').rows()))
