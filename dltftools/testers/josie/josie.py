...
class JOSIETester(AlgorithmTester):
    ...
    def query(self, results_file, k, query_ids, **kwargs):
        ...
        # <query/set_id, list[raw_tokens], list[token_ids]>
...
if __name__ == '__main__':
    ...
    from dltftools.utils.query import sample_queries, read_query_ids
    ...
    datalake_config = ['mongodb', datalake, mongo_datasets]
    dlh = DataLakeHandlerFactory.create_handler(*datalake_config)
