...
class TableBertModel(nn.Module):
    ...
    def load(
        ...
        **override_config: Dict
        ...
        if model_path in ('bert-base-uncased', 'bert-large-uncased'):
            from tools.table_bert.vanilla_table_bert import VanillaTableBert, TableBertConfig
        ...
        if cls == TableBertModel:
            if 'num_vertical_attention_heads' in config_dict:
                from tools.table_bert.vertical.vertical_attention_table_bert import VerticalAttentionTableBert, VerticalAttentionTableBertConfig
        ...
        if state_dict is not None:
            ...
            from tools.table_bert.utils import hf_flag
            if hf_flag == 'new':
    ...
    def from_pretrained(
        ...
        **kwargs
        ...
        from tools.table_bert.vertical.vertical_attention_table_bert import (
        ...
        # if '_bert_model.bert.pooler.dense.weight' in state_dict.keys():
        #     del state_dict['_bert_model.bert.pooler.dense.weight']
        # if '_bert_model.bert.pooler.dense.bias' in state_dict.keys():
        #     del state_dict['_bert_model.bert.pooler.dense.bias']
        # state_dict['span_based_prediction.prediction.decoder.bias'] = 0
