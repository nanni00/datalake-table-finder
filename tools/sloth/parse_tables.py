...
def main():
    ...
    path_tables = '/home/nanni/unimore/tesi-magistrale/data/turl_sloth_wikitables/original_turl_train_tables.jsonl' # "datasets/train_tables.jsonl"  # path of the JSONL file containing the tables
